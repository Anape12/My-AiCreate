...
class CharacterConversationServiceTests(unittest.TestCase):
    def setUp(self):
        ...
        self.provider = Mock()
        self.provider.invoke.return_value = "自然な返答"
        self.prompts = Mock()
    ...
    def test_casual_chat_uses_one_model_call_without_tools(self):
        ...
        self.provider.invoke.assert_called_once()
